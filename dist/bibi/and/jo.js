 ...
 */ !(function(e) {
    ...
    function c(e, t) {
      for (var n = {}, i = [], r = 0; r < e.length; r++) {
        ...
        -1 !== l
          ...
          : a.push({identifier: d, updater: v(f, t), references: 1}),
          i.push(d);
      }
      return i;
    }
        ...
        (e.Bibi = function() {
          ...
          (e.callBibi = function(n) {
            ...
            try {
              if (n instanceof HTMLElement) {
                if (/^iframe$/i.test(n.tagName)) {
                  ...
                  if (!l) return null;
                  (u = n.parentNode.insertBefore(e.create('a', {href: l}), n)),
                    (c = n.parentNode.removeChild(n));
                } else if (/^a$/i.test(n.tagName)) {
                  if (!n.href) return null;
                  (u = n),
                    (c = e.create('iframe')),
                    (a = u.getAttribute('data-bibi-class')) &&
                      a
                        .trim()
                        .replace(/\s+/, ' ')
                        .split(' ')
                    ...
                    (o = u.getAttribute('data-bibi-id')) &&
                      c.setAttribute('id', o),
                    (r = u.getAttribute('data-bibi-style')) &&
            ...
            return (
              ...
              (p.dispatch = function(e) {
                ...
                return (
                  !!t.test(e) &&
                  s.dispatchEvent(new CustomEvent(e, {detail: n}))
                );
              }),
              (p.receive = function(e) {
                return (
                  !!t.test(e) &&
                  c.contentWindow.E.add(e, function(t) {
              ...
              d.length &&
                p.listen('bibi:initialized', function() {
              ...
              e.TrustworthyOrigins.includes(u.origin) ||
                e.TrustworthyOrigins.push(u.origin),
              (u.href +=
                (/#/.test(u.href) ? '&' : '#') +
                ((b = new e.Fragments()).add('parent-bibi-index', p.Index),
                [
                  'autostart-embedded',
                  'autostart',
                  'p',
          ...
          (e.embed = function() {
            ...
            Array.prototype.forEach.call(
              document.body.querySelectorAll('*[data-bibi]'),
              function(n) {
              ...
              t.length &&
                t.forEach(function(i) {
                  ...
                  i.listen('bibi:initialized', function() {
                    return (
                      !(n.push(i) < t.length) &&
                      e.dispatch('bibi:jo:embedded', n)
                    );
                  }),
                    r.parentNode.insertBefore(o, r);
                });
          }),
          document.addEventListener('DOMContentLoaded', e.embed),
          window.addEventListener('load', e.embed),
            ...
            function(t) {
              ...
              try {
                if (
                  ...
                  'object' !=
                    ('undefined' == typeof Data ? 'undefined' : i(Data)) ||
                    !Data)
                )
                  return !1;
          ...
          (e.Fragments = function() {
            return (
              ...
              (this.add = function(e, t) {
                this.FragmentKeys.includes(e) || this.FragmentKeys.push(e),
                  (this.FragmentKeysAndValues[e] = t);
              }),
              (this.make = function() {
                if (!this.FragmentKeys.length) return '';
                for (
                  var t = [], n = this.FragmentKeys.length, i = 0;
                  i < n;
                  i++
                )
                  t.push(
                    ''
                      .concat(this.FragmentKeys[i], '=')
                      .concat(
                        e.encode(
                          this.FragmentKeysAndValues[this.FragmentKeys[i]]
                        )
                      )
                  );
          ...
          (e.judge = function(t, n) {
            return (
              ...
              n &&
              'string' == typeof n &&
              e.TrustworthyOrigins.includes(n)
            );
          }),
          ...
          (e.dispatch = function(n) {
            ...
            return (
              !!t.test(n) &&
              document.dispatchEvent(new CustomEvent(n, {detail: i}))
            );
          }),
          ...
          (!window.CustomEvent ||
            ('function' != typeof window.CustomEvent &&
              -1 ===
                window.CustomEvent.toString().indexOf(
  ...
  function(e, t, n) {
    (t = n(4)(!1)).push([
      e.i,
      '/*! Bibi Frame Style */iframe.bibi-frame{display:inline-block;-webkit-box-sizing:border-box;box-sizing:border-box;position:relative;margin:0;padding:0;border:1px solid #dedede;border-radius:1px;max-width:100%;max-height:100%;width:100%;height:100%;vertical-align:top;line-height:1;text-decoration:none;background:transparent}',
      '',
    ]),
      (e.exports = t);
  },
